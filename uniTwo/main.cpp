...
int main() {
    ...
    auto pixel_delta_u = vector_u / image_width;
    auto pixel_delta_v = vector_v / image_height;

    auto viewport_upper_left = camera_center - vec3(0, 0, focal_length) - 0.5 * vector_u - 0.5 * vector_v;
